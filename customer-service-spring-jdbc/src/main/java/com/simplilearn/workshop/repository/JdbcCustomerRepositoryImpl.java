...
public class JdbcCustomerRepositoryImpl implements CustomerRepository {
	...
	private final String SQL_CUSTOMERS_COUNT = "select count(*) from studentdb.customers";
	private final String SQL_CUSTOMERS_SELECT = "select * from studentdb.customers";
	...
	public List<Customer> findAll() {
		// return jdbcTemplate.query(SQL_CUSTOMER_SELECT,new CustomerMapper());
		//Java SE 9 Lambda Expression
